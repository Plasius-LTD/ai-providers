# ADR-0001: @plasius/ai-providers Package Boundary
...
Create `@plasius/ai-providers` as a standalone public package with independent build, test, governance, and publish readiness. The package starts with a narrow descriptor contract and will receive implementation through tracked Feature/Story/Task work.
